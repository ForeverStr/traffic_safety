<template xmlns="el">
    <div class="home_div">
        ...
        <el-table :data="tableData" style="width: 100%;" :cell-style="rowStyle" >
            ...
            <el-table-column prop="request" label="请求次数" align="center"> </el-table-column>
            <el-table-column prop="pass" label="通过次数" align="center"> </el-table-column>
        ...
        <div>
            <el-dialog  :visible.sync="dialogFormVisible" width="30%">
                <el-form :model="form">
                    ...
                    <el-form-item label="请求次数" label-width="15%">
                        <el-input v-model="form.request" autocomplete="off" style="width: 90%"></el-input>
                    </el-form-item>
                    <el-form-item label="通过次数" label-width="15%">
                        <el-input v-model="form.pass" autocomplete="off" style="width: 90%"></el-input>
                    </el-form-item>
                </el-form>
